...
<main class="addmovie-main">
    <form class="addmovie-card" action="index.php?action=addingMovie" method="post">
        ...
        <div class="addmovie-element">
            ...
            <input class="addmovie-element-input" type="text" name="title" value="<?php echo $informations["title"]; ?>" required>
        </div>

        <div class="addmovie-element">
            <h3 class="addmovie-element-title" >Summary</h3>
            <input class="addmovie-element-input" type="text" name="summary" value="<?php echo $informations["summary"]; ?>" required>
        </div>
